...
public class Editar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edid.setText(MostrarAgenda.usuariosArrayList.get(position).getId());
    ...
    private void Actualizar() {
        ...
        if (nombre.isEmpty()){
            ...
            progressDialog.show();
            StringRequest request =new StringRequest(Request.Method.POST, "http://ec2-54-93-62-124.eu-central-1.compute.amazonaws.com/jveganzones001/WEB/actualizar_.php",
